# create a class called Person. The class should have the following attributes: name, age, 
# and address. The class should have the following methods: eat, sleep, and work. The eat 
...
nzima = Person('nzima',78,'mitchell')
nzima.sleep()
nzima.eat()
nzima.work()